...
import com.santamaria.dronehere.data.Dc1d;
 ...
 */
public class Dc3Adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>  {
    List<Dc1d> dc1d;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ((Dc1ViewHolder)holder).setdc3(dc1d.get(position));
    }

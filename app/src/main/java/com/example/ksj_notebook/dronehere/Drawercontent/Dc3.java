...
public class Dc3 extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dc3);

        recy=(RecyclerView)findViewById(R.id.dc3recy);
        adp=new Dc3Adapter();
        ...
        recy.setLayoutManager(layoutManager);
            NetworkManager.getInstance().getDc3(MyApplication.getContext(), mem_id, new NetworkManager.OnResultListener<Dc1Result>() {
